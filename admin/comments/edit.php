    ...
    <div class="posts col-9">
        ...
        <div class="row add-post">
            <div class="mb-12 col-12 col-md-12 err">
                <!-- ВВиведення масиву з помилками -->
                <?php include "../../app/helps/errorInfo.php"; ?>
            </div>
            <form action="edit.php" method="post">
                <input type="hidden" name="id" value="<?=$id; ?>">
                <div class="col mb-4">
                    <input value="<?=$email?>" name="title" type="text" disabled class="form-control" placeholder="Title" aria-label="Назва статті">
                </div>
                <div class="col">
...
<!-- Додавання візуального редактора до текстового поля адмінки -->
