...
<div class="container">
    ...
    <div class="posts col-9">
        <div class="button row">
            ...
            <a href="<?php echo BASE_URL . "admin/users/index.php";?>" class="col-3 btn btn-warning">Редагувати</a>
        </div>
        ...
        <div class="row add-post">
            ...
            <form action="edit.php" method="post">
                ...
                <div class="col">
                    ...
                    <input name="mail" value="<?=$email;?>" type="email" class="form-control" readonly id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="введіть ваш email...">
                </div>
                <div class="col">
